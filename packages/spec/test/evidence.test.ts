...
void test("VerificationTimestamp should not accept future dates", () => {
  const tomorrow = addDays(new Date(), 1);
  assert.throws(() => new VerificationTimestamp(tomorrow));
});

void test("VerificationTimestamp should calculate isStaleBy correctly", () => {
...
void test("VerificationTimestamp should return expiry date correctly", () => {
  const verifiedDate = new Date("2024-01-01T00:00:00Z");
  const ts = new VerificationTimestamp(verifiedDate);
...
void test("VerificationTimestamp should calculate days until re-verification correctly", () => {
...
void test("EvidenceVerificationEvent should create event with generated ID", () => {
...
void test("EvidenceVerificationEvent should accept custom timestamp", () => {
...
void test("Evidence should create with initial verified event", () => {
...
void test("Evidence should be valid within TTL", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Evidence should be invalid after TTL", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Evidence should report correct status when expired", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Evidence should calculate reVerificationDueDate correctly", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Evidence should detect when reVerification is due", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Evidence should allow verify command", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Evidence should prevent verify if recent conflicts exist", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Evidence should allow reject command", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Evidence should allow recordConflict command", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Evidence should detect recent conflicts", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Evidence should not detect old conflicts (>30 days)", () => {
...
void test("Evidence should return expiry date", () => {
  const ev = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 365
...
void test("Serialization should serialize and deserialize Evidence", () => {
...
void test("Serialization should preserve audit trail through serialization", () => {
  const original = Evidence.create({
    documentKey: testDocKey,
    documentName: "LVD Declaration",
    ttlDays: 1095
